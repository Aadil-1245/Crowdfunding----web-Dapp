  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-opacity-75 bg-deep-purple-accent-700">
        <svg className="relative bg-opacity-75 backgroundMain" viewBox="0 0 1160 163">
          <path
            fill="currentColor"
            d="M-164 13L-104 39.7C-44 66 76 120 196 141c316 162 436 152 556 119.7c676 88 796 34 916 13C1036 -8 1156 2 1216 7.7L1276 13V162.5H1216C1156 162.5 1036 162.5 916 162.5C796 162.5 676 162.5 556 162.5C436 162.5 316 162.5196 162.5C76 162.5 -44 162.5 -104 162.5H-164V13Z"
          />
        </svg>
        <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-13 xl:w-7/12">
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 12 12"
                >
                  <path d="M9.707,5.293V11H8.293V5.293H1.414L6.707,0.586L12.121,5.707L9.707,5.293z" />
                </svg>
              </a>
            </div>
              ...
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form>
                  ...
                  <p className="text-xs text-gray-600 sm:text-sm">
                    Create Campaign to raise funds
                  </p>
                </form>
              </div>
            </div>
